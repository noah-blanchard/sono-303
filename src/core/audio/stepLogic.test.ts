...
describe("stepDurationSeconds", () => {
  ...
  /*
   * SONO-TAPE computes its bounce length in beats, in `src/core/sequencer/tape.ts`,
   * because `src/core/sequencer/` may not import from `src/core/audio/`. That leaves two
