 ...
 * rather than in `src/core/audio/` and imports neither React nor Tone.js.
 */
 ...
 * stays free of any `src/core/audio/` import. The two agree exactly, and a test in
 * `src/core/audio/stepLogic.test.ts` pins them together.
 */
