 ...
 * the knob readouts. Keeping them in `src/core/sequencer/` is what lets the UI show
 * "1.2 kHz" under TONE without importing from `src/core/audio/` (AGENTS.md rule 2).
 *
