import { defaultSonoDistState } from "../../core/sequencer/defaults";
import { isDistPatched } from "../../core/sequencer/patchbay";
import {
  mapLevelToDb,
  mapToneToFrequency,
} from "../../core/sequencer/distortionMapping";
import { useSono303Dispatch, useSono303State } from "../../studio/state/hooks";
import { DistortionModeSelector } from "./DistortionModeSelector";
import { Module } from "../shared/Module";
import { RotaryKnob } from "../shared/RotaryKnob";
import { formatDecibels, formatHz, formatPercent } from "../shared/knobScales";
